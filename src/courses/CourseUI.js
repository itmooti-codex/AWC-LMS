...
export class CourseUI {
  ...
  static renderNavItem(c) {
    ...
    return `
      ...
      // </div>
      // flex items-center gap-2 p-2 text-sm text-neutral-600 hover:bg-[#ebf6f6] focus-visible:bg-neutral-900/10 focus-visible:text-neutral-900 focus-visible:outline-none
    
    <a href="https://courses.writerscentre.com.au/students/course-details/${c.courseUid}?${id}" 
